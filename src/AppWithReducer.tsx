...
function AppWithReducer() {
    ...
    function changeFilter(value: FilterValuesType, todolistId: string) {
        dispatchToTodoistReducer(changeTodolistFilterAC(todolistId, value));
    }

    function removeTodolist(id: string) {
        dispatchToTodoistReducer(removeTodolistAC(id));
        dispatchToTasksReducer(removeTodolistAC(id));
    }

    function changeTodolistTitle(id: string, title: string) {
        dispatchToTodoistReducer(changeTodolistTitleAC(id, title));
    }

    function addTodolist(title: string) {
        const action = addTodolistAC(title); //abracadabra ; v1 = 1
        dispatchToTodoistReducer(action);  //abracadabra ; v1 = 1
        dispatchToTasksReducer(action);  //abracadabra  ; v1 = 1
